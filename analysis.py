...
# Splitting data sets futher to individual aspects of each class for T test
#df1 is Iris setosa (taken out as not required in T test)
...
ise.plot.box(grid='True')
ivi.plot.box(grid='True')
ive.plot.box(grid='True')
plt.show()
...
print ("Jonathan Harper","\n","OUTPUT FOR ANALYSIS.PY","\n")
print ("Data created :",date,"\n")
# Description of whole data set for the file
a = iris.describe()
print ("SECTION 1: HEAD AND FOOT OF FISHER'S IRIS DATA SET","\n")
print (iris)
print ("SECTION 2: DESCRIPTIVE STATS FOR THE WHOLE DATA SET","\n")
print (a)
...
print ("SECTION 6.1.1 The difference between mean values of Iris setosa and Iris virginica attributes are",'\n',abs (x-y),'\n')
print ("SECTION 6.1.2 The difference between mean values of Iris setosa and Iris versicolour attributes are",'\n',abs (x-z),'\n')
print ("SECTION 6.1.3 The difference between mean values of Iris versicolour and Iris virginica attributes are",'\n',abs (y-z),'\n')
